package paytest.ins.com.helper;
...
import paytest.ins.com.common.PayResult;
import paytest.ins.com.common.SignUtils;
...
public class PayHelper {
    ...
    //启动微信支付
    public void callWeixin(LinkedHashMap<String, String> map) {
        onPayStart();
        try {
            if (map != null) {
