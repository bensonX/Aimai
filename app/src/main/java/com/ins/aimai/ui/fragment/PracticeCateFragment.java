...
import com.ins.aimai.ui.adapter.RecycleAdapterPracticeCate;
 ...
 */
public class PracticeCateFragment extends BaseFragment implements OnRecycleItemClickListener {
    ...
    private RecycleAdapterPracticeCate adapter;
    private PagerInter pagerInter;

    public static Fragment newInstance(int position) {
        PracticeCateFragment fragment = new PracticeCateFragment();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        rootView = inflater.inflate(R.layout.fragment_practice_cate, container, false);
        return rootView;
    }
    ...
    private void initCtrl() {
        adapter = new RecycleAdapterPracticeCate(getContext());
