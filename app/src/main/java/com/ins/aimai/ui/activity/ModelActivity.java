...
public class ModelActivity extends BaseAppCompatActivity implements OnRecycleItemClickListener {

    private View showin;
    private ViewGroup showingroup;
    private SpringView springView;
    private RecyclerView recycler;
    private RecycleAdapterModel adapter;
    ...
    private void initCtrl() {
        adapter = new RecycleAdapterModel(this);
