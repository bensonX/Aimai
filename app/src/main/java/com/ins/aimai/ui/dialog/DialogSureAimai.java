 ...
 * 确定取消弹窗
 */
public class DialogSureAimai extends Dialog {
    ...
    public DialogSureAimai(Context context) {
        this(context, "", "确定？", "取消", "确定");
    }

    public DialogSureAimai(Context context, String msg) {
        this(context, "", msg, "取消", "确定");
    }

    public DialogSureAimai(Context context, String title, String msg) {
        this(context, title, msg, "取消", "确定");
    }

    public DialogSureAimai(Context context, String title, String msg, String cancelStr, String sureStr) {
...
//        lp.height = (int) (lp.width*0.65); // 高度
    ...
    private void setLoadingDialog() {
        ...
        View v = inflater.inflate(R.layout.dialog_sure_aimai, null);
    ...
    public static void showDialog(Context context, String msg, final CallBack callBack) {
        final DialogSureAimai dialogSure = new DialogSureAimai(context, msg);
        if (callBack != null) {
