...
public class OfficialActivity extends BaseAppCompatActivity implements OnRecycleItemClickListener {

    private View showin;
    private ViewGroup showingroup;
    private SpringView springView;
    private RecyclerView recycler;
    private RecycleAdapterOfficial adapter;
    ...
    private void initCtrl() {
        adapter = new RecycleAdapterOfficial(this);
    ...
    public void onItemClick(RecyclerView.ViewHolder viewHolder) {
        ExamActivity.startOfficial(this,0,0);
    }
}
